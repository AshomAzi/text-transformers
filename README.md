...
In this project, you are tasked with the objective of making a simple text completion/editing/auto-correction tool.

You are advised to create test files for this project.
